...
namespace f1_eTelemetry
{
    public class MappedBuffer<MappedBufferT>
    {
        ...
        public void Connect()
        {
            //https://www.codeguru.com/csharp/memory-mapped-files-c-sharp/
            //https://www.c-sharpcorner.com/UploadFile/b942f9/using-memory-mapped-files/
            // la gestion de l'exception est gérée dans  private void ConnectTimer_Tick(object sender, EventArgs e) de mainform
